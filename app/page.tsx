          ...
          <div className="container">
            <div className="section-head">
              <div>
                ...
                <h2>Cho B2C, B2B và xuất khẩu</h2>
              </div>
            </div>
        ...
        <section className="section">
          <div className="container grid-2">
            <div className="card">
              ...
              <p className="lead">
                TTD Coffee định vị là Vietnam Coffee Sourcing Network, không
                giới hạn ở một tỉnh.
              </p>

              <div className="origin-list">
                {origins.map((o) => (
                  <div className="origin-item" key={o}>
                    {o}
                  </div>
                ))}
              </div>
            ...
            <div className="card dark-card">
              ...
              <p className="lead">
                Khu vực cập nhật giá Robusta, Arabica, USD/VND, tin tức và báo
                cáo AI hằng ngày.
              </p>
            ...
            <div className="grid-3">
              {posts.map((post) => (
                <a className="card" href={`/blog#${post.slug}`} key={post.slug}>
                  <h3>{post.title}</h3>
                  <p>Bài viết mẫu cho chiến lược SEO ngành cà phê.</p>
                </a>
              ))}
            </div>
          </div>
