    ...
    <section className="hero">
      <div className="container hero-grid">
        <div>
          ...
          <p className="lead">
            TTD Coffee cung cấp cà phê nhân xanh, cà phê rang xay, OEM / Private Label,
            thiết bị và giải pháp xuất khẩu cho nhà rang xay, chuỗi cà phê và nhà nhập khẩu.
          </p>
        ...
        <div className="hero-visual">
          <div>
            <p className="eyebrow" style={{ color: "#C9A227" }}>From Vietnam to the World</p>
            <h2 style={{ color: "white" }}>Vietnam Coffee Sourcing Network</h2>
            <p>Ưu tiên tiếng Việt, có thể chuyển sang English cho khách quốc tế.</p>
          </div>
